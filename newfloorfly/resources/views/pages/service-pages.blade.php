...
@if(isset($category_id))
   @php $pcat=\App\ServiceCategory::find($category_id)->first()->name; @endphp
   @section('head_title', $pcat .' | '.getcong('site_name') )
   @section('head_url', Request::url())

@elseif (isset($subcategory_id))
    @php $scat=\App\ServiceSubcategory::where('id',$subcategory_id)->first()->name; @endphp
    @section('head_title', $scat .' | '.getcong('site_name') )
    @section('head_url', Request::url())

@elseif (isset($subsubcategory_id))
    @php $sscat=\App\ServiceChildcategory::where('id',$subsubcategory_id)->first()->name; @endphp
    @section('head_title', $sscat .' | '.getcong('site_name') )
    @section('head_url', Request::url())
@else
